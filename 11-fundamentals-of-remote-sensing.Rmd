...
(ref:11-nadar-caption) Images of the Arc de Triomphe in Paris, France taken by Tournachone from a balloon in 1968 [@nadar_arc_1868].

```{r 11-nadar, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-nadar-caption)"
} else { 
...
(ref:11-hermosilla-canada-landcover-caption) Landcover classification of Canada generated by Hermosilla et al. for the year 2005 [@hermosilla_disturbance-informed_2018].

```{r 11-hermosilla-canada-landcover, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-hermosilla-canada-landcover-caption)"
} else { 
...
(ref:11-EMS-caption) Electromagnetic (also known as Milton) spectrum depicting the type, wavelength, frequency and black body emission temperature [@inductiveload_em_2007].

```{r 11-EMS, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-EMS-caption)"
} else { 
...
(ref:11-scattering-caption) Depiction of Rayleigh, Mie and non-selective scattering [@the_good_doctor_fry_diagram_2011], CC-BY-SA-4.0.

```{r 11-scattering, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-scattering-caption)"
} else { 
...
(ref:11-solar-radiation-caption) Solar radiation spectrum from 250 - 2500 nm. Irradiance measurements at the top of the atmosphere (yellow) and sea level (red) are depicted. The grey line represents the theoretical curve of a 5250 degree C blackbody spectrum [@rohde_solar_2008], CC-BY-SA-3.0.

```{r 11-solar-radiation, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-solar-radiation-caption)"
} else { 
...
(ref:11-reflectors-caption) Depictions of specular and diffuse reflectors [@beck_specular_2012], CC-BY-SA-3.0.

```{r 11-reflectors, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-reflectors-caption)"
} else { 
...
```{r 11-specsig, fig.cap = fig_cap, out.width = "75%", echo = FALSE}
...
```{r 11-radiometric, fig.cap = fig_cap, out.width = "75%", echo = FALSE}
...
(ref:11-hermo-false-caption) False colour composite (bands: shortwave infrared, near infrared and red) for 2010. Each pixel in this image was selected based on its classification as a Best Available Pixel (BAP) [@hermosilla_disturbance-informed_2018].

```{r 11-hermo-false, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-hermo-false-caption)"
} else { 
...
(ref:11-hermo-disturb-caption) Temporal sequences depicting landcover before and after (a) harvesting and (b) fire. The year of change is represented by 'Y' [@hermosilla_disturbance-informed_2018].

```{r 11-hermo-disturb, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:11-hermo-disturb-caption)"
} else { 
