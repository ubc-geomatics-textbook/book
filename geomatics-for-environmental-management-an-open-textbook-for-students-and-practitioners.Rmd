...
```{r 1-cli-agriculture-capability-toronto, fig.cap = fig_cap, out.width= "100%", echo = FALSE, fig.align="center"}
...
output:
  pdf_document:
    latex_engine: xelatexgit pull origin develop
---
...
``` {r 2-CGVD-leaflet, echo=FALSE, out.width="100%", fig.cap=fig_cap}
  fig_cap <- paste0("The difference (in meters) between the Canadian Geodetic Vertical Datum of 2013 (CGVD2013) and the Canadian Geodetic Vertical Datum of 1928 (CGVD28). <a
  href='",baseurl,"#fig:2-CGVD-leaflet'>Animated figure can be viewed in the web browser version of the textbook</a>. Data from Natural Resources Canada and licensed under the <a href='",nrcanlicense,"'>Open Government Licence - Canada</a>. Pickell, CC-BY-SA-4.0.")
if (knitr:::is_latex_output()) {
...
```{r 2-geodesy-visualization-static, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    ...
    knitr::include_graphics(here::here("images", "02-geodesy-visualization-static.png"))
```
<br/>
...
```{r 3-elevation, echo=FALSE, out.width = '75%', fig.cap=fig_cap}
fig_cap <- paste0("Elevation of the Sunshine Coast in BC, from the NRCAN DEM (google earth engine) [@nrcan_canadian_2021]")
...
fig_cap <- paste0("Global lighting strike density per month. Skeeter, CC-BY-SA-4.0.")
...
fig_cap <- paste0("The ratio between two temperatures in Celsius is not meaningful, 20&deg;C is not 'twice' as warm as 10&deg;C. Kelvin's zero point is fixed to absolute zero, the 'absence' of temperature.  So we can calculate the ratio, 293.15&deg;K is 1.035 times warmer than 283.15&deg;K. Skeeter, CC-BY-SA-4.0.")
...
fig_cap <- paste0("Income vs. household expenditures on Food by Census Subdivisions in BC. Skeeter, CC-BY-SA-4.0.")
knitr::include_graphics("images/03-income-v-food.png")
```

```{r 3-income-v-income-on-food, echo=FALSE, out.width = '75%', fig.cap=fig_cap}
fig_cap <- paste0("Income vs. Fraction of Income Spent on Food by Census Subdivisions in BC. Skeeter, CC-BY-SA-4.0.")
...
(ref:4-crooked-aerialphoto-caption) Example of how a linear feature can appear crooked in an aerial photograph that has not yet been orthorectified due to relief displacement. @dibiase_census_2014, CC-BY-4.0.
...
(ref:4-accessing-aerial-photos-caption) Example showing the availabiltiy of historical aerial photos in eastern Newfoundland at three time steps. Data from @natural_resources_canada_earth_nodate, Open Government License - Canada.
...
```{r echo=FALSE, warning=FALSE}
yml_content <- yaml::read_yaml("chapterauthors.yml")
author <- yml_content[["topology"]][["author"]]
coauthor <- yml_content[["topology"]][["coauthor"]]
```

# Topology and Geocoding {#topology}
...
```{r 7-haida-gwaii-leaflet, fig.cap = fig_cap, out.width= "50%", echo = FALSE}
  fig_cap <- paste0("Singlepart geometry of the Haida Gwaii archipelago off the west coast of British Columbia, Canada. Hover over the islands to see the names. <a href='",baseurl,"#7-haida-gwaii-leaflet'>Animated figure can be viewed in the web browser version of the textbook.</a> Polygon data from @statistics_canada_statistics_nodate and island placenames from @natural_resources_canada_natural_nodate. <a href='",canadalicense,"'>Open Government License - Canada</a>.")
m2
```
...
fig_cap <- paste0("The five Platonic solids are examples of regular, convex polyhedrons and multipatch geometries. From left to right: tetrahedron (4 faces); hexahedron (6 faces); octahedron (8 faces); dodecahedron (12 faces); and icosahedron (20 faces). <a href='",baseurl,"#7-platonic-polyhedrons'>Animated figure can be viewed in the web browser version of the textbook.</a> @cyp_polyhedra_2005, CC-BY-SA-3.0.")
...
```{r 9-mount-assiniboine-hillshade-animation, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Hillshade of Mount Assiniboine at the border of Alberta and British Columbia, Canada.<a href='",baseurl,"#fig:9-mount-assiniboine-hillshade-animation'> Animated figure can be viewed in the web browser version of the textbook.</a> Data from @natural_resources_canada_canadian_2015. Online version is animated across all azimuths from 0° to 350° by 10° intervals. Pickell, CC-BY-SA-4.0.")
...
```{r 9-nelson-river-hillshade-animation, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Hillshade of Nelson River pouring into Hudson Bay, Manitoba, Canada. <a href='",baseurl,"#fig:9-nelson-river-hillshade-animation'>Animated figure can be viewed in the web browser version of the textbook.</a> Data from @earth_resources_observation_and_science_center_usgs_2018. Online version is animated across azimuths from 0° to 350° by 10° intervals. Pickell, CC-BY-SA-4.0.")
...
```{r 9-sink-fill, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Animated process of filling sinks in a DEM.<a href='",baseurl,"#fig:9-sink-fill'> Animated figure can be viewed in the web browser version of the textbook</a>. Online version is animated. Pickell, CC-BY-SA-4.0.")
...
```{r 9-leaflet-map-layers, echo=FALSE, out.width="100%", fig.cap=fig_cap}
fig_cap <- paste0("Input layers and output prediction raster for the Chowade Watershed Management basin.<a href='",baseurl,"#fig:9-leaflet-map'> Animated figure can be viewed in the web browser version of the textbook</a>. Data from @city_of_vancouver_notitle_2009 and licensed under the  under the <a href='",covlicence,"'>Open Government License - Vancouver</a>. Lam, CC-BY-SA-4.0.")
if (knitr:::is_latex_output()) {
...
```{r 9-vancouver-building-height-extruded, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Animation showing building polygons in Vancouver, British Columbia extruded by a height attribute. <a href='",baseurl,"#fig:9-vancouver-building-height-extruded'>Animated figure can be viewed in the web browser version of the textbook</a>. Building data from @city_of_vancouver_notitle_2009, licensed under <a href='",covlicence,"'>Open Government License - Vancouver</a>. Base map © @openstreetmap_notitle_nodate contributors, licensed under Open Data Commons Open Database License. Pickell, CC-BY-SA-4.0.")
