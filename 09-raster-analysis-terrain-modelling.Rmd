...
(ref:9-MRVBF-diagram-caption) Multi-Resolution Valley Bottom Flatness (MRVBF) Computational Components described by [@gallant_multiresolution_2003]. Melser, CC-BY-SA-4.0.

```{r 9-MRVBF-diagram, echo=FALSE, out.width = '75%', fig.cap=fig_cap}
if (knitr:::is_latex_output()) { 
  fig_cap <- "(ref:9-MRVBF-diagram-caption)"
} else { 
  fig_cap <- paste0("Multi-Resolution Valley Bottom Flatness (MRVBF) Computational Components described by [@gallant_multiresolution_2003]. Melser, CC-BY-SA-4.0.")
}
...
if (knitr:::is_latex_output()) { 
  ...
  fig_cap <- fig_cap <- paste0("Anaglyph of Mount Odin on Baffin Island, Nunavut, Canada. Imagery by [@maxar_precision3d_nodate]. Pickell, CC-BY-SA-4.0.")
}
...
(ref:9-mount-logan-exaggeration-caption) Elevation exaggeration of Mount Logan elevation, Yukon Territory, Canada. Digital Elevation Model by [@natural_resources_canada_canadian_2015]. Pickell, CC-BY-SA-4.0.
